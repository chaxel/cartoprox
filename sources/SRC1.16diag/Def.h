...
/*-----------------------------------*/
/*Modif Atmo RA : passage 100 caracteres -> 256 caracteres*/
/*dans tableaux name_emisrue name_emisnoeud name_emisponct*/
typedef struct DonIter{
  ...
  Meteo met;
  /*------------------*/
  DBL Mod_rue,Mod_noeud,Mod_ponct;
  /*------------------*/
...
typedef struct Donnees{
  ...
  /*----------------------*/
  int affich,calc_stat,ordre,champ;
  int GrdRatio;
  Recept *Rec;
  /*------------------*/
} Donnees;
