      ...
      !version
      character(len=5),parameter :: versionstr='1.2'
      ...
      integer            :: projection_i       ! projection CARTESIENNE dans laquelle est definie le cadre (0=geo, 1=L2E, 2=UTM31)
      integer ,parameter :: projection_o=1     ! projection du fichier MIF (0=geo, 1=L2E, 2=UTM31) 
      ...
      real            :: dy_recept_max 
      real, parameter :: dy_recept_max_defaut = 1000.
      ...
      integer, parameter :: nclass_recept_defaut = 10000 ! laisser ce nombre
      integer            :: nclass_recept !utilisateur  parametre -nc 
      real, parameter    :: facteur_geom_defaut = 2.
      real               :: facteur_geom !utilisateur parametre -fc
                    
      real, allocatable :: dy_recept(:) !nclass_recept) ! calcule a partir de dx_recept_ini suivant une suite geometrique de raison r_dy_recept
      real, allocatable :: r_dy_recept(:) !nclass_recept)
      ! data dy_recept /  10., 30., 90., 270.,  810.,  2430. /

      ! distance à la voie
      real, allocatable  :: dx_recept(:) !nclass_recept calcule a partir de dy_recept
