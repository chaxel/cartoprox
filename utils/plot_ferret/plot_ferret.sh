...
TMPDIR=${SCRATCH}/${script}.${xmin_plot}_${xmax_plot}_${ymin_plot}_${ymax_plot}.$RANDOM
while [ -d ${SCRATCH}/${script}.${xmin_plot}_${xmax_plot}_${ymin_plot}_${ymax_plot}.$RANDOM ] ; do
TMPDIR=${SCRATCH}/${script}.${xmin_plot}_${xmax_plot}_${ymin_plot}_${ymax_plot}.$RANDOM
done
...
if [ ${zoom_level} -ge 6 ] && [ "${valeur_limite[1]}" != "" ] ; then 
...
echo "Execute FERRET"
ferret -${output_mode} < ${TMPDIR}/ferret.com > ${TMPDIR}/ferret.log
...
case ${post_opt} in
#crop)convert -shave 60x60  -trim ${TMPDIR}/${tmp_gif} ${fichier_gif};;
crop)convert -trim +repage ${TMPDIR}/${tmp_gif} ${fichier_gif};;
*)cp ${TMPDIR}/${tmp_gif} ${fichier_gif};;
esac

cd ${localdir}
rm ${TMPDIR}/${tmp_gif}
rm ${TMPDIR}/ferret.jnl
rm ${TMPDIR}/ferret.com
rm ${TMPDIR}/carto.jnl
rm ${TMPDIR}/ferret.log
rmdir ${TMPDIR}
