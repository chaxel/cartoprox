...
C	  Rz = -0.41321/3600. !DK
      ...
      else if ( ((gs1.EQ.1).AND.(gs2.EQ.3)).or.
     &          ((gs1.EQ.4).AND.(gs2.EQ.3))    ) then !WGS84/GRS80->NTF
      ...
      else if ( ((gs1.EQ.3).AND.(gs2.EQ.1)).or.
     &          ((gs1.EQ.3).AND.(gs2.EQ.4))    ) then !NTF->WGS84/GRS80
	  Tx = -168.  !données IGN NTF->WGS84 
	  Ty =  -60.  !données IGN NTF->WGS84 
	  Tz =  320.  !données IGN NTF->WGS84 
	  Rx =    0.
      ...
      else if ((gs1.EQ.1).AND.(gs2.EQ.4)) then !WGS84->GRS80
	  Tx =    0.  !données IGN GRS80->WGS84 
	  Ty =    0.  !données IGN GRS80->WGS84 
	  Tz =    0.  !données IGN GRS80->WGS84 
	  Rx =    0.
	  Ry =    0.
	  Rz =    0.
	  D =    Ddef
      ...
      else if ((gs1.EQ.4).AND.(gs2.EQ.1)) then !GRS80->WGS84
	  Tx =    0.  !données IGN GRS80->WGS84 
	  Ty =    0.  !données IGN GRS80->WGS84 
	  Tz =    0.  !données IGN GRS80->WGS84 
	  Rx =    0.
