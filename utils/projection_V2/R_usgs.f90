      SUBROUTINE lamccfor(r_maj,r_min,lat1,lat2,c_lon,c_lat,&
                    false_east,false_north,scale_fact,lon_1,lat_1,x_,y_)
...
!			functions_proj.f90
	...
	DOUBLE PRECISION ::scale_factor           ! scale_factor	  
	...
	DOUBLE PRECISION   ::scale_fact     ! scale_factor		
...
!
      SUBROUTINE lamccinv(r_maj,r_min,lat1,lat2,c_lon,c_lat,&
                    false_east,false_north,scale_fact,x_1 ,y_1,lon_,lat_)
	! E. Chaxel June 200
	! chaxeleric@yahoo.fr
	! DRP version 1.0
	IMPLICIT NONE
