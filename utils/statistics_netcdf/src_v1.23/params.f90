...
! especes gazeuses (pour l'instant O3 seulement)
      ...
      real,allocatable :: nox_0(:,:,:)
      real,allocatable :: pm10_0(:,:) 
      real,allocatable :: pm25_0(:,:)       
...
!!!!!!!!! Moyennes !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
      ...
      real,allocatable :: pm25_moy_jour(:,:)
      real,allocatable :: n_pm25_moy_jour(:,:)
!!!!!!!!! O3 ozone !!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!!!!!!!!! NO2 dioxyde d azote !!!!!!!!!!!!!!!!!!
      real,allocatable :: nox_max_1hr_jour(:,:,:)
...
!!!!!!!! PM10!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
! switch
      logical :: ipm, ipm25, igaz, iphno3, iecart, iaot_foret, iaot_veg, icreate, ino
...
! test
      ...
      character(len=256) :: nox_var(2)
      character(len=256) :: pm10_var 
      character(len=256) :: pm25_var        
